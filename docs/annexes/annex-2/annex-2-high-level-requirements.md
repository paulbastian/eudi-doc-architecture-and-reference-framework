...
| WIRevocation_07 | A Wallet Provider SHALL be able to revoke a Wallet Instance, by revoking its WIA(s) as specified in \[[Topic 7](#a237-topic-7---attestation-validity-checks-and-revocation)\] or by stoping issuance of short-lived WIAs. |
