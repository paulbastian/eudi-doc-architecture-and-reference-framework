...
| **Index** | **Requirement specification** |
|------------|------------------|
| WIRevocation_06 | A Wallet Provider SHALL be able to suspend a Wallet Instance, by suspending its WIA(s) as specified in \[[Topic 7](#a237-topic-7---attestation-validity-checks-and-revocation)\] or by stoping issuance of short-lived WIAs. |
